                            ...
                            <div class="table-responsive">
                                <table id="tblusuario"width="100%">
                                    ...
                                    <tbody>
                                        <?php 
                                        include('../controlador/conexion.php');
                                        $sql = "SELECT a.id_medicamento, a.nombre, b.num_lote, b.stock_actual,b.fecha_vencimiento FROM medicamento as a INNER JOIN detalle_ingreso as b ON a.id_medicamento = b.id_medicamento WHERE b.estado = 1";
                                        ...
                                        ?>
                                            ...
                                            <td><?php 
                                                    ...
                                                    if($dias <= 0){
                                                        ...
                                                        //echo "<a href='../controlador/proceso_baja.php?id=$fila[fecha_vencimiento]' class='boton-eliminar'>Dar de baja </a> ";
                                                        
                                                    }      
                                                    elseif ($dias <= 183) {
                                                        echo '<span class="status red"></span> Por Vencer';
                                                    } elseif ($dias <= 365) {
                                                        echo '<span class="status yellow"></span> Precausión';
                                                    } else{
