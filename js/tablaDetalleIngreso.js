...
function getRowSelected(objectPressed){
	...
	var fechaIngreso=a.getElementsByTagName("td")[0].getElementsByTagName("p")[0].innerHTML;
	var cbProveedor=a.getElementsByTagName("td")[1].getElementsByTagName("p")[0].innerHTML;
    var txtProveedor=a.getElementsByTagName("td")[2].getElementsByTagName("p")[0].innerHTML;
	var cbMedicamento=a.getElementsByTagName("td")[3].getElementsByTagName("p")[0].innerHTML;
    var txtMedicamento=a.getElementsByTagName("td")[4].getElementsByTagName("p")[0].innerHTML;
	var fechaVencimiento=a.getElementsByTagName("td")[5].getElementsByTagName("p")[0].innerHTML;
	var lote=a.getElementsByTagName("td")[6].getElementsByTagName("p")[0].innerHTML;
	var cantidad=a.getElementsByTagName("td")[7].getElementsByTagName("p")[0].innerHTML;
	...
	var array_fila = [fechaIngreso, cbProveedor, txtProveedor, cbMedicamento, txtMedicamento, fechaVencimiento, lote, cantidad];
...
function newRowTable()
{
	...
	var cbProveedor=document.getElementById("cbProveedor").value;


    var selProveedor = document.getElementById("cbProveedor");
    var textProveedor= selProveedor.options[selProveedor.selectedIndex].text;
    var txtProveedor = textProveedor;
...
//	var total_n=parseFloat(subtotal)+parseFloat(impuesto);
    ...
    cell1.innerHTML = '<p name="fechaIngreso_f[]" class="non-margin">'+fechaIngreso+'</p>';
    cell2.innerHTML = '<p name="cbProveedor_p[]" class="non-margin">'+cbProveedor+'</p>';
    cell3.innerHTML = '<p name="txtProveedor_p[]" class="non-margin">'+txtProveedor+'</p>';
    cell4.innerHTML = '<p name="cbMedicamento_p[]" class="non-margin">'+cbMedicamento+'</p>';
    cell5.innerHTML = '<p name="txtMedicamento_p[]" class="non-margin">'+txtMedicamento+'</p>';
    cell6.innerHTML = '<p name="fechaVencimiento_p[]" class="non-margin">'+fechaVencimiento+'</p>';
    cell7.innerHTML = '<p name="lote_p[]" class="non-margin">'+lote+'</p>';
    cell8.innerHTML = '<p name="cantidad_p[]" class="non-margin">'+cantidad+'</p>';
    cell9.innerHTML = '<button class="fa-eraser">Quitar</button>';
